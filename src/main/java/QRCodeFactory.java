...
public class QRCodeFactory {
     ...
     */
    public void CreatQrImageAndLogo(String content, String format, String outFileUri, String logUri, int... size) throws
        ...
        BitMatrix bitMatrix = new MultiFormatWriter().encode(content,//要编码的内容
                ...
                //MaxiCode 2D barcode,PDF417,QR Code 2D,RSS 14,RSS EXPANDED,UPC-A 1D,UPC-E 1D,UPC/EAN extension,
                // UPC_EAN_EXTENSION
     ...
     * @throws WriterException 抛出书写异常
     */
    public void CreatQrImage(String content, String format, String outFileUri,int... size) throws
            IOException, WriterException {
        int width = 430; // 二维码图片宽度 430
        int height = 430; // 二维码图片高度430
